...
# parser.add_argument('--dataset', type=str, default='music', help='which dataset to use')    # default = music
# parser.add_argument('--dim', type=int, default=64, help='dimension of entity and relation embeddings')  # default = 16
...
# parser.add_argument('--n_epoch', type=int, default=10, help='the number of epochs')     # default = 10
...
parser.add_argument('--item_update_mode', type=str, default='plus_transform',
                    help='how to update item at the end of each hop')
parser.add_argument('--using_all_hops', type=bool, default=True,   # 设成False，test auc acc都有所提高？
                    help='whether using outputs of all hops or just the last hop when making prediction')
